document.addEventListener('DOMContentLoaded', async () => {
    ...
    const eventsEndpoint = 'http://127.0.0.1:3000/event/type/offline';
    ...
    function renderCards() {
        ...
        events.slice(0, visibleCards).forEach(event => {
            ...
            if (window.location.href === 'http://127.0.0.1:5500/cust/pelatihan-offline.html' || window.location.href === 'http://127.0.0.1:5500/cust/index.html') {
                image.src = '../assets/img/course_cover.webp'; // Mengubah src jika sesuai
            } else if (window.location.href === 'https://learnonid.github.io/cust/pelatihan-offline.html' || window.location.href === 'https://learnonid.github.io/cust/index.html') {
                image.src = '../assets/img/course_cover.webp'; // Mengubah src jika sesuai
            } else {
            ...
            if (window.location.href === 'http://127.0.0.1:5500/cust/pelatihan-offline.html' && eventDate >= today) {
            ...
            } else if (window.location.href === 'https://learnonid.github.io/cust/pelatihan-offline.html' && eventDate >= today) {
                const registerButton = document.createElement('button');
                registerButton.className = 'mt-4 bg-blue-500 text-white py-2 px-4 rounded hover:bg-blue-600';
                registerButton.textContent = 'Daftar';
                registerButton.addEventListener('click', () => {
                ...
                cardContent.appendChild(registerButton);
            } else if (window.location.href === 'http://127.0.0.1:5500/cust/pelatihan-offline.html' && eventDate >= today) {
                const registerButton = document.createElement('button');
                registerButton.className = 'mt-4 bg-blue-500 text-white py-2 px-4 rounded hover:bg-blue-600';
                registerButton.textContent = 'Daftar';
                registerButton.addEventListener('click', () => {
